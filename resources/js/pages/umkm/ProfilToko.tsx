...
import {
    LayoutDashboard, LogOut, Package, Store, Tag, Save, User as UserIcon
} from 'lucide-react';
            ...
            <div className="flex min-h-screen bg-slate-50 text-slate-900">
                ...
                <aside className="fixed inset-y-0 left-0 z-40 flex w-72 flex-col bg-emerald-950 text-emerald-100">
                    ...
                    <nav className="flex-1 px-4 py-6 space-y-1">
                        ...
                        <Link href={route('umkm.profil.edit')} className="flex w-full items-center gap-3 rounded-xl bg-emerald-600 px-4 py-3 text-sm font-bold text-white shadow-lg shadow-emerald-900/40">
